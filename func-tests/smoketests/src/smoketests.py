...
def create_content(spaceKey, title):
	...
	print(".............passed")
	time.sleep(5) # 5 seconds delay to allow index get updated
	return content_id
...
def retrieve_attachment(content_id):
	...
	assert r.status_code == 200, f'failed to find the attachments! status:{r.status_code}'
	result = json.loads(r.text)
	title = result['results'][0]['title']
	assert title.startswith('tmp'), "The attachment file is not found!"
